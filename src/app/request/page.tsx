...
export default function RequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        alert(
          "Ваш запрос успешно отправлен! Менеджер свяжется с вами в течение 30 минут."
        );
        // Сброс формы
        setFormData({
          name: "",
                  ...
                  <div className="form-grid">
                    {[
                      ...
                      },
                      {
                        ...
                        name: "position",
                        type: "text",
                        placeholder: "Руководитель отдела маркетинга",
                        icon: <Send size={20} />,
                      },
                      {
                        label: "Компания",
                ...
                <div style={{ marginBottom: "3rem" }}>
                  ...
                  >
                    {[
                      {
                        id: "clothing",
                        label: "Корпоративная одежда",
                        desc: "Футболки, толстовки, поло",
                      },
                      {
                        id: "accessories",
                        label: "Аксессуары",
                        desc: "Кружки, рюкзаки, Power Bank",
                      },
                      {
                        id: "gifts",
                        label: "Подарочные наборы",
                        desc: "Премиум подарки для партнеров",
                      },
                    ].map((cat) => (
                      <label
                        key={cat.id}
