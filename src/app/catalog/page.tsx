  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(
          "Ошибка отправки. Пожалуйста, попробуйте еще раз или позвоните нам."
        );
      }
    } catch (error) {
                  ...
                  <div className="form-grid">
                    <div>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <span>
                            Образцы продукции по запросу (при заказе от 300 тыс.
                            руб.)
                          </span>
                        </li>
                        <li
                        ...
                        >
                          ...
                          />
                          <span>
                            Помощь в разработке дизайна и подборе материалов
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="form-actions">
                        ...
                        <button
                          type="submit"
                          className="form-submit form-submit-orange"
                        >
                          <Upload size={18} />
                          Отправить запрос
                        </button>
          ...
          >
            ...
            <div className="field-group">
              ...
              <div className="checkbox-group">
                ...
                />
                <label htmlFor="complex-clothing" className="checkbox-label">
              ...
              <div className="checkbox-group">
                <input
                  type="checkbox"
                  id="complex-accessories"
                  className="checkbox-input"
                />
                <label htmlFor="complex-accessories" className="checkbox-label">
                  Аксессуары и промопродукция
                </label>
              </div>
              <div className="checkbox-group">
                <input
                  ...
                  className="checkbox-input"
                />
                <label htmlFor="complex-gifts" className="checkbox-label">
                  Подарочные наборы
                </label>
              </div>
            </div>
