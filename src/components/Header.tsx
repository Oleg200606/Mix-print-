        ...
        <header className="header">
            ...
            {isMobileMenuOpen && (
                <div className="mobile-menu">
                    ...
                    <Link href="/catalog" className="mobile-menu-link" onClick={() => setIsMobileMenuOpen(false)}>
                        Каталог и Услуги
                    </Link>
                    <Link href="/request" className="mobile-menu-link" onClick={() => setIsMobileMenuOpen(false)}>
                        Оптовый запрос
                    </Link>
