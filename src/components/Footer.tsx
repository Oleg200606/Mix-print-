    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <p className="footer-text">
              Производство корпоративного мерча и промопродукции для крупного
              бизнеса. Работаем только с оптовыми заказами от юридических лиц.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="footer-list">
              <li>
                <a href="/catalog">Корпоративная одежда</a>
              </li>
              <li>
                <a href="/catalog">Печать на аксессуарах</a>
              </li>
              <li>
                <a href="/catalog">Подарочные наборы</a>
              </li>
              <li>
                <a href="/catalog">Крупный опт</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p>
            © {new Date().getFullYear()} МИКС ПРИНТ. Все права защищены.
