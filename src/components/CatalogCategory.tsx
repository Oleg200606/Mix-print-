    ...
    <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-lg hover:shadow-xl transition">
      ...
      <div className="p-8">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
          <div
            className={`flex-shrink-0 rounded-xl p-4 ${category.imageColor} text-white`}
          >
            {category.icon}
          </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-green-100 text-green-600 flex items-center justify-center mr-3 flex-shrink-0">
                    ✓
                  </div>
                  <span>
                    Индивидуальный расчет в течение 2 часов в рабочее время
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-green-100 text-green-600 flex items-center justify-center mr-3 flex-shrink-0">
                  ...
                  <span>
                    Образцы продукции по запросу (при заказе от 300 тыс. руб.)
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-green-100 text-green-600 flex items-center justify-center mr-3 flex-shrink-0">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Прикрепите файлы:</strong> логотип, техническое
                  задание, референсы. Это ускорит расчет.
                </p>
              </div>
            </div>
