        ...
        <section className="hero">
            <div className="hero-content">
                ...
                <p className="hero-subtitle">
                    Полный цикл производства одежды и аксессуаров с нанесением логотипа для IT-компаний, банков и холдингов.
                    <strong className="block mt-2"> Работаем только с крупным оптом.</strong>
                </p>
